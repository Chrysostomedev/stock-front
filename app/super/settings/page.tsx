...
export default function SuperSettingsPage() {
  ...
  return (
    <AppLayout
      ...
      subtitle="Personnalisez le thème visuel et les configurations des tickets de caisse de votre Supérette"
      rightElement={
      ...
      <div className="flex flex-col gap-6 max-w-4xl mx-auto pb-12">
        ...
        <Card className="p-6 flex flex-col gap-5 border border-zinc-150 dark:border-zinc-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-bold text-foreground">Configuration du Ticket de Caisse</h3>
              <p className="text-xs text-zinc-400">Définissez les en-têtes et pieds de page imprimés sur vos tickets thermiques</p>
            </div>
          </div>

          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-black text-zinc-500 uppercase">En-tête du Ticket</label>
              <textarea
                value={receiptHeader}
                onChange={(e) => setReceiptHeader(e.target.value)}
                placeholder="Ex: SP SERVICES&#10;Votre superette préférée"
                rows={3}
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-black text-zinc-500 uppercase">Pied de page du Ticket</label>
              <textarea
                value={receiptFooter}
