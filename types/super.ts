...
export enum ExpenseCategory {
  ...
  PURCHASE_ORDER = "PURCHASE_ORDER", // Achat fournisseur (auto-généré)
  STOCK_INITIAL = "STOCK_INITIAL",   // Stock initial (auto-généré)
  OTHER = "OTHER",             // Autres
}
...
export interface Expense {
  ...
  isAutoGenerated: boolean;  // Générée automatiquement par le backend (read-only)
  shopId: string;
